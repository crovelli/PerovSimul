#include "PhysicsListGeantino.hh"
...
PhysicsListGeantino::PhysicsListGeantino()
: G4VUserPhysicsList()
{
...
void PhysicsListGeantino::ConstructParticle()
{
  // pseudo-particles
...
void PhysicsListGeantino::ConstructProcess()
{
  AddTransportation();
...
void PhysicsListGeantino::SetCuts()
{
  SetCutsWithDefault();
}
